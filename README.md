# Bem vindo ao repositório do projeto Frontend Online Store!

## Comentários
Projeto semelhante a um loja online, sem persistência de dados, desenvolvido em grupo suas funcionalidades de acordo com demandas definidas em um quadro Kanban, em um cenário próximo ao do mercado de trabalho. Foi muito interessante desenvolver esse projeto, pois trabalhei em um grupo de pessoas que não conhecia, e foi muito bom, pois aprendi muito com eles, e também pude ensinar algumas coisas que já sabia. Foi uma experiência muito boa.

---

## Desenvolvido em conjunto com:
- [Gabriel Proença Araujo](https://github.com/GPA1992)
- [Tiago Dias Laureano](https://github.com/tiago-dias-laureano)
- [Vitoria Pizzo](https://github.com/vitoriaelizv)
...
```
git clone git@github.com:lucas-da-silva/project-front-end-online-store.git
```
